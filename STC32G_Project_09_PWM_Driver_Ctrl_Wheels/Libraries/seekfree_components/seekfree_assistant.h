...
extern seekfree_assistant_oscilloscope_struct               xdata seekfree_assistant_oscilloscope_data;                         // 虚拟示波器数据
extern float                                                xdata seekfree_assistant_parameter[SEEKFREE_ASSISTANT_SET_PARAMETR_COUNT];    // 保存接收到的参数
extern vuint8												xdata seekfree_assistant_parameter_update_flag[SEEKFREE_ASSISTANT_SET_PARAMETR_COUNT];
