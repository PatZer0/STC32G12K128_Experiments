...
static  fifo_struct     xdata bluetooth_ch9141_fifo;
static  uint8           xdata bluetooth_ch9141_buffer[BLUETOOTH_CH9141_BUFFER_SIZE];  // 数据存放数组

static  uint8   xdata bluetooth_ch9141_data;
